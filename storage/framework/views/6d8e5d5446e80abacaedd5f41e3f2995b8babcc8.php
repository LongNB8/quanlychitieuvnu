...
<div class="page-content-wrapper animated fadeInRight">
  <div class="page-content" >
    <div class="wrapper border-bottom page-heading">
      <div class="col-lg-12">
        <h2> Sửa đơn vị  <?php echo e($donvi->ten); ?></h2>
        <ol class="breadcrumb">
      ...
      <div class="row">
        ...
        <div class="col-lg-12 mt-md-2  mb-md-2">
          <div class="widgets-container">
            ...
            <form action="<?php echo e(URL::to('/admin/daotao/'.$donvi->id)); ?>" name="themtc" class="themtieuchi" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input placeholder="Tên tiêu chí" class="form-control" type="text" name="tendonvi" value="<?php echo e($donvi->ten); ?>">
                </div>
              </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dragon\Desktop\phattrienweb\resources\views/admin/education/edit_donvi.blade.php ENDPATH**/ ?>