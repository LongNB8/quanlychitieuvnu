      ...
      <div class="page-sidebar sidebar-light">
        <ul class="page-sidebar-menu  page-header-fixed ">
          ...
          <li class="nav-item">
            ...
            <ul class="sub-menu">
            <li class="nav-item">
                <a class="nav-link nav-toggle" href="<?php echo e(URL::to('/admin/daotao/create')); ?>"> <span class="title">Thêm đơn vị</span> </a>
              </li>
              <li class="nav-item">
                <a class="nav-link nav-toggle" href="<?php echo e(URL::to('/admin/daotao')); ?>"> <span class="title">Danh sách đơn vị</span> </a>
              </li>
            </ul>
          </li>
          <?php endif; ?>
...
</html><?php /**PATH C:\Users\dragon\Desktop\phattrienweb\resources\views/admin/layout/admin_layout.blade.php ENDPATH**/ ?>