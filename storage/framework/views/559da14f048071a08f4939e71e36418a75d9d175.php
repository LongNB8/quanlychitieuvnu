...
<div class="container-chart">
    <div class="click-school">
        ...
        <input type="checkbox" name="school[]" id="getvl-click-school" value="<?php echo e($tr->id); ?>"><label
            style="margin-left: 3px;" id="lbl-nameschool"><?php echo e($tr->ten); ?></label><br>
        ...
        <form action="" method="POST">
            ...
            <div class="form-group-chart">
                ...
                <select name="nam" id="nam">
                    ...
                    <?php for($i = 2020; $i < 2025; $i++): ?> <option value="<?php echo e($i); ?>"><?php echo e($i); ?></option>
                        <?php endfor; ?>
                </select>
...
<script>
    ...
    tieuchi.addEventListener('change', function(){
        ...
        $.ajax({
            url: "<?php echo e(route('getnamthongke')); ?>",
            type: 'POST',
            dataType: 'json',
            data: {
                id: this.value,
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\phattrienweb\resources\views/chart/demo.blade.php ENDPATH**/ ?>